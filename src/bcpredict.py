...
if __name__ == '__main__':
    ...
    temp_df = temp_df[temp_df.BICYCLE_ACCIDENT == 'Y'][:20000].append(temp_df[temp_df.BICYCLE_ACCIDENT == 'N'])
    ...
    y_label = temp_df[['BICYCLE_ACCIDENT']]
    bc_accidents = bcAccidents()
    bc_accidents.trainModel(df,y_label)
    bc_accidents.save("models/bcAccidents")